...
const JSON_LD: object[] = [
  {
    ...
    url: 'https://learn.eesha.onrender.com/v2',
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Eesha Learn 2.0', item: 'https://learn.eesha.onrender.com/v2' },
    ],
  },
];
...
export const EeshaLearn2Page: React.FC = () => {
        ...
        <section className="v2-hero">
          ...
          <div className="seo-cta-group">
            <Link
              ...
              onClick={() => trackClickCTA('eesha-learn-v2', '/editor')}
            >
              <svg
                width="16"
                height="16"
