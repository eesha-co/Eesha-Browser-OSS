...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. Eesha Learn loads ngspice compiled to WebAssembly via the open-source eecircuit-engine. The same SPICE engine that powers professional EDA workflows runs in your browser tab — no server, no install.',
  },
  {
  ...
  },
  {
    ...
    a: 'Eesha Learn builds the netlist for you from the schematic — wire components on the canvas and the simulator generates the SPICE cards. You don’t have to handwrite netlists, but the underlying engine is full ngspice and accepts standard device cards.',
  },
  {
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free Online SPICE Simulator (ngspice-WASM)',
    ...
    url: 'https://learn.eesha.onrender.com/spice-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/spice-simulator',
      },
    ],
  },
];
      ...
      <main>
        ...
        <section className="seo-hero">
          ...
          <p className="subtitle">
            Eesha Learn runs the open-source ngspice engine compiled to WebAssembly. Real device models,
        ...
        <section className="seo-section">
          <h2>Why Eesha Learn for SPICE?</h2>
          <p className="lead">
            Browser SPICE has historically meant either no SPICE at all (linear approximators) or
            hosted-only tools that need an account. Eesha Learn runs the real engine, locally, for free.
          </p>
