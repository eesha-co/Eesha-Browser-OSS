...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Yes. The ESP32-C3 uses the RISC-V RV32IMC instruction set. Eesha Learn also supports the CH32V003 (RV32EC at 48 MHz) — another popular RISC-V microcontroller.',
  },
  {
    q: 'Which ESP32-C3 boards are supported?',
    a: 'Eesha Learn supports ESP32-C3 DevKitM-1, Seeed XIAO ESP32-C3, and ESP32-C3 SuperMini (Aitewinrobot). All three use the same RISC-V core.',
  },
  {
    q: 'Can I use Arduino code with ESP32-C3?',
    a: 'Yes. Eesha Learn compiles your .ino sketch using the official ESP32 Arduino core with the ESP32-C3 board target. All standard Arduino functions work — Serial, GPIO, analogRead, etc.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free ESP32-C3 & RISC-V Simulator',
    ...
    url: 'https://learn.eesha.onrender.com/esp32-c3-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/esp32-c3-simulator',
      },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn emulates RISC-V microcontrollers through the QEMU lcgamboa fork — the same
