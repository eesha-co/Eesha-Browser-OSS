...
export const AboutPage: React.FC = () => {
  useSEO({
    ...
    jsonLd: {
      ...
      '@type': 'AboutPage',
      name: 'About Eesha Learn',
      description: 'Learn about Eesha Learn and its creator David Montero Crespo.',
      url: 'https://learn.eesha.onrender.com/about',
    },
  });
    ...
    <div className="about-page">
      ...
      <section className="about-hero">
        <div className="about-hero-inner">
          <h1 className="about-hero-title">About Eesha Learn</h1>
      ...
      <section className="about-section">
        <div className="about-container">
          <div className="about-story">
            ...
            <p>
              Eesha Learn started as a personal exploration into how microcontroller emulators work
            ...
            <p>
              Eesha Learn v1 launched on Product Hunt and Hacker News, supporting Arduino Uno and
              Raspberry Pi Pico. The feedback from the maker and embedded community was incredible —
              and it pushed the project forward.
            </p>
            <p>
              <strong>Eesha Learn 2.0</strong> shipped with ESP32 emulation via QEMU (using the lcgamboa
      ...
      <section className="about-section">
        <div className="about-container">
          ...
          <p>
            Eesha Learn is <strong>100% open source</strong> under the AGPLv3 license. No cloud
          ...
          <p>
            Eesha Learn was inspired by{' '}
            <a href="https://wokwi.com" target="_blank" rel="noopener noreferrer">
              Wokwi
            </a>
            , which is a fantastic tool. The goal of Eesha Learn is to take a different path: fully open
      ...
      <section className="about-cta">
        <div className="about-container">
          <h2>Ready to try Eesha Learn?</h2>
