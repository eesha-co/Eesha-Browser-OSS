  ...
  useSEO({
    ...
    jsonLd: {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'Is Eesha Learn free?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Eesha Learn is completely free and open-source under the GNU AGPLv3 license. No account required, no cloud subscription. Run it at learn.eesha.onrender.com or self-host with one Docker command.',
          },
        },
        {
          '@type': 'Question',
          name: 'Can Eesha Learn simulate analog circuits?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Eesha Learn 2.5 includes real-time SPICE analog simulation via ngspice compiled to WebAssembly. You can mix passive and active analog parts (resistors, capacitors, op-amps, BJTs, MOSFETs, regulators, diodes) with Arduino, ESP32, and RP2040 firmware on the same canvas — GPIO drives SPICE nets, ADC reads solved node voltages.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Eesha Learn implements the Wokwi Custom Chips API. Write your chip in C, Rust, or AssemblyScript; Eesha Learn compiles it to WebAssembly and runs it on the canvas like any other component, with pin I/O, attribute reads, timers, and I²C/SPI bus integration.',
          },
        },
        {
          '@type': 'Question',
          name: 'Does Eesha Learn work offline?',
          acceptedAnswer: {
            '@type': 'Answer',
        ...
        {
          '@type': 'Question',
          name: 'What boards does Eesha Learn support?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Eesha Learn supports 19 boards across 5 CPU architectures: AVR8 (Arduino Uno, Nano, Mega 2560, ATtiny85, Leonardo, Pro Mini), RP2040 (Raspberry Pi Pico, Pico W), RISC-V (ESP32-C3, XIAO ESP32-C3, CH32V003), Xtensa QEMU (ESP32, ESP32-S3, ESP32-CAM, Nano ESP32), and ARM Cortex-A53 QEMU (Raspberry Pi 3B running Linux).',
          },
        },
        {
          '@type': 'Question',
          name: 'Is Eesha Learn a Wokwi / Falstad / Tinkercad alternative?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Eesha Learn is a free, self-hosted alternative to Wokwi for microcontroller simulation, and a more accurate alternative to Falstad and Tinkercad for analog circuits — Eesha Learn runs the real ngspice engine and also runs the firmware on the microcontroller driving the circuit, all in one tool.',
          },
        },
      ],
    },
    ...
    <div className="landing">
        ...
        <div className="hero-right">
          <picture>
            ...
            <img
              ...
              alt="Eesha Learn editor with Arduino Uno traffic-light circuit"
      ...
      <section className="landing-support">
        <div className="support-content">
          ...
          <p className="support-sub">
            Eesha Learn is free and open source. If it saves you time, consider supporting its
            development.
          </p>
      ...
      <footer className="landing-footer">
        ...
        <div className="footer-links">
          ...
          <span style={{ fontSize: 12, color: 'var(--text-dim)' }}>Our Products:</span>
          <a href="https://eeshamart.onrender.com" target="_blank" rel="noopener noreferrer">
            EeshaMart
          </a>
          <a href="https://juanovacortex.netlify.app" target="_blank" rel="noopener noreferrer">
            Juanova Cortex
          </a>
          <a href="https://learn.eesha.onrender.com" target="_blank" rel="noopener noreferrer" style={{ opacity: 0.6 }}>
            Eesha Learn ✓
          </a>
        </div>
