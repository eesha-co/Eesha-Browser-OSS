...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. Eesha Learn uses avr8js — the cycle-accurate AVR8 emulator — to execute compiled ATtiny85 firmware byte-for-byte exactly as it would run on a real DIP-8 chip.',
  },
  {
  ...
  {
    q: 'How do I program the ATtiny85 in Eesha Learn?',
    a: 'Write your sketch in the Monaco editor in C/C++ (Arduino syntax). Eesha Learn compiles it via the bundled arduino-cli using the ATTinyCore board package and produces a real .hex file — the same one you would flash via USBasp.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Eesha Learn includes a real-time SPICE solver — wire the ATtiny85 ADC pin to a voltage divider, an op-amp output, or an NTC thermistor bridge and analogRead() will return the actual SPICE-solved voltage at that pin.',
  },
  {
    q: 'Is it free?',
    a: 'Yes — Eesha Learn is fully free and open-source under GNU AGPLv3. No account required.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free Online ATtiny85 Simulator',
    ...
    url: 'https://learn.eesha.onrender.com/attiny85-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/attiny85-simulator',
      },
    ],
  },
];
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            ...
            Eesha Learn's strength with the SPICE solver wired in.
          </p>
          <div className="seo-grid">
            <div className="seo-card">
