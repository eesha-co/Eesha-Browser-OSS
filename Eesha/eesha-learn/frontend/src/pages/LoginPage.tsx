...
export const LoginPage: React.FC = () => {
  useSEO({
    title: 'Sign In — Eesha Learn',
    description:
      'Sign in to your Eesha Learn account to save projects and access your Arduino simulations.',
    url: 'https://learn.eesha.onrender.com/login',
    noindex: true,
  });
  ...
  return (
    <div className="ap-page">
      <div className="ap-card">
        ...
        <p className="ap-card-sub">to continue to Eesha Learn</p>
