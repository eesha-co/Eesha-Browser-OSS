...
export const RegisterPage: React.FC = () => {
  useSEO({
    title: 'Create Account — Eesha Learn',
    description:
      'Create a free Eesha Learn account to save your Arduino projects and share simulations.',
    url: 'https://learn.eesha.onrender.com/register',
    noindex: true,
  });
