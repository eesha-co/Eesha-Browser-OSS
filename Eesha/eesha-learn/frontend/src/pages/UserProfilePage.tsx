...
export const UserProfilePage: React.FC = () => {
  ...
  useSEO({
    title: `${username ?? 'User'} — Eesha Learn Profile`,
    description: `View Arduino and ESP32 projects by ${username ?? 'this user'} on Eesha Learn.`,
    url: `https://learn.eesha.onrender.com/${username ?? ''}`,
    noindex: true,
  });
