...
const BASE_URL = 'https://learn.eesha.onrender.com';
const AUTHOR = {
  '@type': 'Person',
...
const IntroSection: React.FC = () => (
  <div className="docs-section">
    ...
    <h1>Introduction</h1>
    <p>
      <strong>Eesha Learn</strong> is a fully local, open-source Arduino emulator that runs entirely in
    ...
    <div className="docs-callout">
      ...
      <a href="https://learn.eesha.onrender.com" target="_blank" rel="noopener noreferrer">
        learn.eesha.onrender.com
      </a>{' '}
...
const GettingStartedSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      ...
      <a href="https://learn.eesha.onrender.com" target="_blank" rel="noopener noreferrer">
        https://learn.eesha.onrender.com
      </a>{' '}
...
arduino-cli core install rp2040:rp2040`}</CodeBlock>
    ...
    <ol>
      <li>
        ...
        <a href="https://learn.eesha.onrender.com/editor" target="_blank" rel="noopener noreferrer">
          learn.eesha.onrender.com/editor
        </a>
        .
      </li>
      <li>
...
const EmulatorSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      Eesha Learn uses <strong>real CPU emulation</strong> rather than a simplified model. This document
...
const ComponentsSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      Eesha Learn ships with <strong>48+ interactive electronic components</strong> powered by{' '}
...
const RoadmapSection: React.FC = () => (
  <div className="docs-section">
    ...
    <h1>Roadmap</h1>
    <p>Features that are implemented, in progress, and planned for future releases of Eesha Learn.</p>
...
const ArchitectureSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      Eesha Learn is a fully local Arduino emulator using official Wokwi repositories for maximum
...
const WokwiLibsSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      Eesha Learn uses official Wokwi open-source repositories cloned locally in <code>third-party/</code>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Parse a Wokwi <code>diagram.json</code> → Eesha Learn circuit
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            Serialise a Eesha Learn circuit → Wokwi <code>diagram.json</code>
          </td>
        </tr>
        <tr>
          <td>
...
python mcp_sse_server.py --port 8002`}</CodeBlock>
  ...
  "mcpServers": {
    ...
    <p>Eesha Learn circuits are plain JSON objects:</p>
    <CodeBlock language="json">{`{
...
const SetupSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>A comprehensive overview of all features currently implemented in Eesha Learn.</p>
...
const RiscVEmulationSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      ...
      architecture at 160 MHz. Eesha Learn emulates them through the same QEMU-based backend as the
...
const Esp32EmulationSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      ...
      production-quality Xtensa emulator is available as pure JavaScript, Eesha Learn uses a
    ...
    <h2>Requirements</h2>
    <p>
      QEMU-based emulation requires the Eesha Learn backend to be running. This means it works with the{' '}
...
const RaspberryPi3EmulationSection: React.FC = () => (
  <div className="docs-section">
    ...
    <p>
      ...
      . This is the only board in Eesha Learn that runs a full operating system, a real{' '}
      ...
      '@graph': [
        {
          ...
          url: pageUrl,
          isPartOf: { '@type': 'WebSite', url: `${BASE_URL}/`, name: 'Eesha Learn' },
          inLanguage: 'en-US',
          author: AUTHOR,
        },
        {
