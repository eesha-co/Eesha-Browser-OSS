...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. Eesha Learn is completely free and open-source (GNU AGPLv3). No account, no payment, no cloud subscription — run it in your browser or self-host it with one Docker command.',
  },
  {
  ...
  },
  {
    ...
    a: 'Eesha Learn supports 19 boards: Arduino Uno (ATmega328P), Arduino Nano, Arduino Mega 2560, ATtiny85, Arduino Leonardo, Arduino Pro Mini (AVR8) — plus Raspberry Pi Pico (RP2040), ESP32-C3 / XIAO ESP32-C3 / CH32V003 (RISC-V), ESP32 / ESP32-S3 / ESP32-CAM (Xtensa via QEMU), and Raspberry Pi 3B (Linux via QEMU).',
  },
  {
    q: 'Can I simulate LEDs, sensors, and displays?',
    a: 'Yes. Eesha Learn includes 48+ interactive wokwi-elements: LEDs, resistors, buttons, servo motors, ultrasonic sensors, ILI9341 TFT displays, LCD, NeoPixel strips, buzzers, DHT22, and more.',
  },
  {
    q: 'Is Eesha Learn a Wokwi alternative?',
    a: 'Yes. Eesha Learn is a free, self-hosted alternative to Wokwi. It uses the same avr8js emulation library and wokwi-elements visual components, but runs entirely on your own machine with no cloud dependency.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free Online Arduino Simulator',
    ...
    url: 'https://learn.eesha.onrender.com/arduino-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/arduino-simulator',
      },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn simulates Arduino programs with full AVR8 CPU accuracy — including GPIO ports,
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn uses <strong style={{ color: '#e6edf3' }}>avr8js</strong> — the battle-tested
