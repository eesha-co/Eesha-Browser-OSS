...
const FAQ_ITEMS = [
  {
    q: 'What is a custom chip in Eesha Learn?',
    a: 'A custom chip is a user-defined integrated circuit. You write the chip\'s logic in C, Rust, or AssemblyScript — Eesha Learn compiles it to WebAssembly, instantiates it on the canvas like any other component, and drives its pins from the simulator.',
  },
  {
    q: 'Which API does Eesha Learn use?',
    a: 'Eesha Learn implements the Wokwi Custom Chips API — the same API used by Wokwi — so chips you write for Eesha Learn are portable to Wokwi and vice versa. Eesha Learn adds a WASI shim so you can use standard library functions in your chip code.',
  },
  {
    q: 'What can I build?',
  ...
  },
  {
    ...
    a: 'Save the chip to your Eesha Learn account and reuse it across projects. The chip definition includes its pin layout, attributes, and the compiled WASM — drop it onto any project canvas like a built-in component.',
  },
  {
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free Online Custom Chip Simulator',
    ...
    url: 'https://learn.eesha.onrender.com/custom-chip-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/custom-chip-simulator',
      },
    ],
  },
];
      ...
      <main>
        ...
        <section className="seo-hero">
          ...
          <p className="subtitle">
            ...
            the chip in C, Rust, or AssemblyScript; Eesha Learn compiles it to WebAssembly and runs it on
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            The Eesha Learn Custom Chips runtime is fully Wokwi-compatible, with extras for the SPICE
