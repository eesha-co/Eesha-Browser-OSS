...
/* ── Our Products links ────────────────────────────────── */
const PRODUCTS: { name: string; url: string; desc: string; current?: boolean }[] = [
  {
    name: 'EeshaMart',
    url: 'https://eeshamart.onrender.com',
    desc: 'Shop electronics, kits & components',
  },
  {
    name: 'Juanova Cortex',
    url: 'https://juanovacortex.netlify.app',
    desc: 'AI-powered platform',
  },
  {
    name: 'Eesha Learn',
    url: 'https://learn.eesha.onrender.com',
    desc: 'IoT & Circuit Simulator',
    current: true,
  },
];
        ...
        <div className="header-left">
          ...
          <div className="header-brand">
            ...
            <Link to="/" style={{ textDecoration: 'none', color: 'inherit' }}>
              <span className="header-title">Eesha Learn</span>
            </Link>
          </div>
          ...
          <nav className={'header-nav-links' + (menuOpen ? ' header-nav-open' : '')}>
            ...
            <div className="header-products" ref={productsRef}>
              <button
                className={'header-nav-link header-products-trigger' + (productsOpen ? ' header-products-trigger-open' : '')}
              ...
              >
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  style={{ transition: 'transform 0.15s', transform: productsOpen ? 'rotate(180deg)' : 'rotate(0deg)' }}
                >
                  <path d="M4 6l4 4 4-4" />
                </svg>
              </button>
              {productsOpen && (
                <div className="header-products-dropdown">
                  {PRODUCTS.map((p) => (
                    <a
                      key={p.name}
                      href={p.url}
                      ...
                      className="header-products-item"
                      onClick={() => setProductsOpen(false)}
                    >
                      <div className="header-products-item-info">
                        <span className="header-products-item-name">
                          {p.name}
                          {p.current && <span className="header-products-badge">You&apos;re here</span>}
                        </span>
                        <span className="header-products-item-desc">{p.desc}</span>
                      </div>
                      {!p.current && (
                        <svg
                          width="12"
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="header-products-external"
                        >
