...
Eesha Learn is an open-source Arduino emulator that runs entirely in your browser. Follow these steps to simulate your first Arduino sketch.

---

## Option 1: Use the Hosted Version

No installation needed — go to **[https://learn.eesha.onrender.com](https://learn.eesha.onrender.com)** and start coding immediately.
...
1. **Open the editor** at [learn.eesha.onrender.com/editor](https://learn.eesha.onrender.com/editor) (or your local instance).
...
- **Live Demo:** [learn.eesha.onrender.com](https://learn.eesha.onrender.com)
...
- [Introduction](./intro.md) — What is Eesha Learn and why use it
