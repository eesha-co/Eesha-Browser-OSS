...
const FAQ_ITEMS = [
  {
    q: 'Is Eesha Learn a complete electronics simulator?',
    a: 'Yes. Eesha Learn combines a SPICE-accurate analog solver, 19 simulated microcontrollers (Arduino, ESP32, RP2040, ATtiny85, Raspberry Pi 3), 100+ components, an oscilloscope, voltmeter, ammeter, and signal generator — everything you need to design and validate an electronics project end-to-end.',
  },
  {
  ...
  {
    q: 'Is Eesha Learn a Tinkercad / Falstad alternative?',
    a: 'Yes — and a more accurate one. Eesha Learn runs real ngspice (the engine professional EDA tools use), and unlike those tools it also runs the firmware on the microcontroller driving the circuit. Open-source under AGPLv3.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free Online Electronics Simulator',
    ...
    url: 'https://learn.eesha.onrender.com/electronics-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/electronics-simulator',
      },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn is free under AGPLv3 — no licence cost, no per-seat pricing, no cloud account.
