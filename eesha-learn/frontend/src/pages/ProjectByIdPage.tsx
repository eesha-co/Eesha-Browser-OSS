...
export const ProjectByIdPage: React.FC = () => {
  ...
  useSEO(
    projectMeta && projectMeta.isPublic
      ? {
          title: `${projectMeta.name} by ${projectMeta.ownerUsername} | Eesha Learn`,
          description: projectMeta.description
            ? `${projectMeta.description} — Simulate and remix this Arduino project on Eesha Learn.`
            : `Arduino project by ${projectMeta.ownerUsername}. View and simulate it free on Eesha Learn.`,
          url: `${DOMAIN}/project/${id}`,
        }
      : {
          title: 'Project — Eesha Learn Arduino Emulator',
          description:
            'View and simulate this Arduino project on Eesha Learn — free, open-source multi-board emulator.',
          url: `${DOMAIN}/editor`,
          noindex: true,
        },
  );
