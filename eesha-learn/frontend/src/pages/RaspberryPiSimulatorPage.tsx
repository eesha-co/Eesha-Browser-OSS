...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. Eesha Learn emulates a full Raspberry Pi 3B using QEMU raspi3b — ARM Cortex-A53 quad-core at 1.2 GHz running Raspberry Pi OS (Linux). You get a real terminal to run Python, bash, and system commands.',
  },
  {
    q: 'Is this Raspberry Pi simulator free?',
    a: 'Yes. Eesha Learn is 100% free and open-source (GNU AGPLv3). No account, no subscription — simulate Raspberry Pi 3 code in your browser or self-host with Docker.',
  },
  {
  ...
  },
  {
    ...
    a: 'Raspberry Pi Pico (RP2040) is a microcontroller — runs Arduino C++ code, no OS. Raspberry Pi 3 is a full Linux computer — runs Python, bash, and system services. Eesha Learn supports both.',
  },
  {
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free Raspberry Pi 3 Simulator',
    ...
    url: 'https://learn.eesha.onrender.com/raspberry-pi-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/raspberry-pi-simulator',
      },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn emulates a complete Raspberry Pi 3B — not just GPIO pins, but the entire Linux
