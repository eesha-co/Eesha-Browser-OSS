...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. Eesha Learn is fully free and open-source under the GNU AGPLv3 license. No account required, no cloud subscription, no paywalled components — every part of the simulator runs in your browser.',
  },
  {
    q: 'What kind of analog simulation does Eesha Learn use?',
    a: 'Eesha Learn runs ngspice — the open-source SPICE simulator used by professional EDA tools — compiled to WebAssembly via eecircuit-engine. Each tick performs a full Modified Nodal Analysis solve, so non-linear devices (diodes, BJTs, MOSFETs, op-amps with saturation) behave like real silicon, not idealised approximations.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Eesha Learn includes a multi-channel oscilloscope, voltmeter, ammeter, and signal generator (sine, square, DC) as live instruments you can drop on the canvas. They probe any node or wire and update in real time as the simulation runs.',
  },
  {
    q: 'Is this a Falstad / CircuitLab / Tinkercad alternative?',
    a: 'For analog circuits, yes — and a more accurate one, since Eesha Learn runs the real ngspice engine instead of a simplified solver. Unlike those tools, Eesha Learn also runs the firmware on the microcontroller driving the circuit, so you can validate firmware + hardware together without leaving the browser.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn — Free Online Circuit Simulator',
    ...
    url: 'https://learn.eesha.onrender.com/circuit-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/circuit-simulator',
      },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn runs the real ngspice solver — the same engine professional EDA tools use — on
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn uses <strong style={{ color: '#e6edf3' }}>ngspice-WASM</strong> via the
          ...
          <div className="seo-grid">
            <div className="seo-card">
              <h3>1. Wire</h3>
              <p>
                Drop components, drag wires. Eesha Learn union-finds the wire graph into SPICE nets in
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Most browser circuit simulators stop at passive analog. Eesha Learn also runs the firmware on
        ...
        <div className="seo-bottom">
          ...
          <div className="seo-internal-links">
            ...
            <Link to="/v2-5">Eesha Learn 2.5 Release</Link>
