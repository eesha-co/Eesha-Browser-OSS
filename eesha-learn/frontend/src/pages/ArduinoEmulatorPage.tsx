...
const FAQ_ITEMS = [
  ...
  {
    q: "How accurate is Eesha Learn's Arduino emulation?",
    a: 'Eesha Learn uses avr8js, which provides cycle-accurate AVR8 instruction emulation. Every AVR opcode is faithfully emulated at 16 MHz, making it reliable for developing and debugging real firmware before flashing to hardware.',
  },
  {
    q: 'Which Arduino boards can Eesha Learn emulate?',
  ...
  {
    q: 'How is Eesha Learn different from Wokwi?',
    a: 'Eesha Learn is fully self-hosted and open-source under GNU AGPLv3. It uses the same avr8js emulation library as Wokwi but runs entirely on your own machine — no cloud dependency, no registration, no subscription.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn Arduino Emulator',
    ...
    url: 'https://learn.eesha.onrender.com/arduino-emulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://learn.eesha.onrender.com/' },
      {
        ...
        item: 'https://learn.eesha.onrender.com/arduino-emulator',
      },
    ],
  },
];
      ...
      <main>
        ...
        <section className="seo-hero">
          ...
          <p className="subtitle">
            Eesha Learn is a cycle-accurate Arduino emulator running entirely in your browser. Every AVR
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn uses <strong style={{ color: '#e6edf3' }}>avr8js</strong> for AVR8 and{' '}
