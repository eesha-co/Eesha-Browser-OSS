/**
 * /v2 — Eesha Learn 2.0 Release Landing Page
...
const GITHUB_URL = 'https://github.com/eesha-co/eesha-learn';
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Eesha Learn 2.0 — Multi-Board Embedded Systems Simulator',
    applicationCategory: 'DeveloperApplication',
    operatingSystem: 'Any (browser-based)',
    softwareVersion: '2.0.0',
    description:
      'Eesha Learn 2.0 — simulate Arduino, ESP32, Raspberry Pi Pico, and Raspberry Pi 3 in your browser. 19 boards, 68+ examples, realistic sensor simulation. Free and open-source.',
    url: 'https://eesha-learn.dev/v2',
  ...
  },
  {
    ...
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Eesha Learn', item: 'https://eesha-learn.dev/' },
      { '@type': 'ListItem', position: 2, name: 'Eesha Learn 2.0', item: 'https://eesha-learn.dev/v2' },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            From 8-bit AVR to quad-core ARM Linux — Eesha Learn 2.0 emulates every major embedded
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Most simulators limit you to one board at a time. Eesha Learn lets you place multiple boards
          ...
          <div className="v2-multiboard">
            ...
            <div className="seo-grid" style={{ marginTop: 24 }}>
              ...
              <div className="seo-card">
                ...
                <p>
                  Traditional simulators emulate one board in isolation. Eesha Learn simulates entire
        ...
        <section className="seo-section">
          <h2>The outcome</h2>
          <p className="lead">
            Eesha Learn 2.0 transforms the project into a complete, scalable multi-platform embedded
            systems simulator.
          </p>
          <div className="seo-grid">
            <div className="seo-card">
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Eesha Learn is powered by these open-source projects. Without them, none of this would be
            possible.
          </p>
