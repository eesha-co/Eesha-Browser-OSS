# Eesha Learn: Arduino & Embedded Board Emulator

**Live at [learn.eesha.onrender.com](https://learn.eesha.onrender.com)**
...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-learn.eesha.onrender.com-007acc?style=for-the-badge)](https://learn.eesha.onrender.com)
...
Eesha Learn is free and open-source. Building and maintaining a full multi-board emulator takes a lot of time — if it saves you time or you enjoy the project, sponsoring me directly helps keep development going.
...
**[https://learn.eesha.onrender.com](https://learn.eesha.onrender.com)** — no installation needed. Open the editor, write your sketch, and simulate directly in the browser.
...
docker run -d \
  --name eesha-learn \
  -p 3080:80 \
  -v eesha-learn-data:/app/data \
  -v eesha-learn-arduino-libs:/root/.arduino15 \
...
- `eesha-learn-data` → `/app/data`: SQLite DB, project sketch files, auto-generated `SECRET_KEY`
- `eesha-learn-arduino-libs` → `/root/.arduino15`: arduino-cli config + installed
...
| `DATABASE_URL` | `sqlite+aiosqlite:////app/data/eesha-learn.db` | SQLite path |
...
> **Running learn.eesha.onrender.com itself?** Production-only configuration (host nginx
...
Eesha Learn uses a **dual-licensing** model:
